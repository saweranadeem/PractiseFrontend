...
const AddUser = () => {
    ...
    const roles = [
        "Clinic Admin", "Doctor/Therapist", "Clinical Staff", "Billing Staff","Other Admin Staff"," Patient","Super Admin"
    ];
                                        ...
                                        <Col lg={6}>
                                            <div className="mb-3">
                                                ...
                                                <Input
                                                    ...
                                                    invalid={validation.errors.fname && validation.touched.fname ? true : false}
                                                />
                                        ...
                                        <Col lg={6}>
                                            <div className="mb-3">
                                                ...
                                                <Input
                                                    ...
                                                    onBlur={validation.handleBlur}
                                                    onChange={validation.handleChange}
                                                    invalid={validation.errors.lname && validation.touched.lname ? true : false}
                                                />
                                            ...
                                            <FormGroup>
                                                <Label for="insurance-accepted">Role</Label>
                                                    <Input
                                                        ...
                                                        onChange={validation.handleChange}
                                                        onBlur={validation.handleBlur}
                                                        invalid={validation.errors.role && validation.touched.role ? true : false}
                                                    >
