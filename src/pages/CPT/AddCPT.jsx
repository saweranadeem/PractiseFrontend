...
import { Container, Row, Col, Card,Breadcrumb, CardHeader, CardBody, Form, FormGroup, Label, Input, FormFeedback, Nav, NavItem, NavLink } from 'reactstrap'; // Assuming you use Reactstrap for UI components
                                        ...
                                        <Col lg={6}>
                                            <div className="mb-3">
                                                ...
                                                <Input
                                                    ...
                                                    invalid={validation.errors.cptCode && validation.touched.cptCode ? true : false}
                                                />
                                                {validation.errors.cptCode && validation.touched.cptCode && (
                                                    <FormFeedback type="invalid">{validation.errors.cptCode}</FormFeedback>
                                                )}
                                            </div>
                                        </Col>
                                        ...
                                        <Col lg={6}>
                                            <div className="mb-3">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={validation.handleChange}
                                                    onBlur={validation.handleBlur}
                                                    invalid={validation.errors.codeType && validation.touched.codeType ? true : false}
                                                >
                                                ...
                                                {validation.errors.codeType && validation.touched.codeType && (
                                                    <FormFeedback type="invalid">{validation.errors.codeType}</FormFeedback>
                                                )}
                                            </div>
                                        </Col>
                                        ...
                                        <Col lg={6}>
                                            <div className="mb-3">
                                                ...
                                                <Input
                                                    ...
                                                    onBlur={validation.handleBlur}
                                                    onChange={validation.handleChange}
                                                    invalid={validation.errors.shortDescription && validation.touched.shortDescription ? true : false}
                                                />
                                                {validation.errors.shortDescription && validation.touched.shortDescription && (
                                                    <FormFeedback type="invalid">{validation.errors.shortDescription}</FormFeedback>
                                                )}
                                            </div>
                                        </Col>
                                        ...
                                        <Col lg={6}>
                                            <div className="mb-3">
                                                ...
                                                <Input
                                                    ...
                                                    onBlur={validation.handleBlur}
                                                    onChange={validation.handleChange}
                                                    invalid={validation.errors.longDescription && validation.touched.longDescription ? true : false}
                                                />
                                                {validation.errors.longDescription && validation.touched.longDescription && (
                                                    <FormFeedback type="invalid">{validation.errors.longDescription}</FormFeedback>
                                                )}
                                            </div>
                                        </Col>
                                        ...
                                        <Col lg={6}>
                                            <div className="mb-3">
                                                ...
                                                <Input
                                                    ...
                                                    onBlur={validation.handleBlur}
                                                    onChange={validation.handleChange}
                                                    invalid={validation.errors.effectiveDate && validation.touched.effectiveDate ? true : false}
                                                />
                                                {validation.errors.effectiveDate && validation.touched.effectiveDate && (
                                                    <FormFeedback type="invalid">{validation.errors.effectiveDate}</FormFeedback>
                                                )}
                                            </div>
                                        </Col>
                                        ...
                                        <Col lg={6}>
                                            <div className="mb-3">
                                                ...
                                                <Input
                                                    ...
                                                    onBlur={validation.handleBlur}
                                                    onChange={validation.handleChange}
                                                    invalid={validation.errors.expirationDate && validation.touched.expirationDate ? true : false}
                                                />
                                                {validation.errors.expirationDate && validation.touched.expirationDate && (
                                        ...
                                        <Col lg={6}>
                                            <div className="mb-3">
                                                ...
                                                <Input
                                                    ...
                                                    onBlur={validation.handleBlur}
                                                    onChange={validation.handleChange}
                                                    invalid={validation.errors.defaultUnits && validation.touched.defaultUnits ? true : false}
                                                />
                                                {validation.errors.defaultUnits && validation.touched.defaultUnits && (
                                                    <FormFeedback type="invalid">{validation.errors.defaultUnits}</FormFeedback>
                                                )}
                                            </div>
                                        </Col>
                                        ...
                                        <Col lg={6}>
                                            <div className="mb-3">
                                                ...
                                                <Input
                                                    ...
                                                    onBlur={validation.handleBlur}
                                                    onChange={validation.handleChange}
                                                    invalid={validation.errors.defaultModifier && validation.touched.defaultModifier ? true : false}
                                                />
                                                {validation.errors.defaultModifier && validation.touched.defaultModifier && (
                                                    <FormFeedback type="invalid">{validation.errors.defaultModifier}</FormFeedback>
                                                )}
                                            </div>
                                        </Col>
                                        ...
                                        <Col lg={6}>
                                            <div className="mb-3">
                                                ...
                                                <Input
                                                    ...
                                                    onBlur={validation.handleBlur}
                                                    onChange={validation.handleChange}
                                                    invalid={validation.errors.feeSchedule && validation.touched.feeSchedule ? true : false}
                                                />
                                                {validation.errors.feeSchedule && validation.touched.feeSchedule && (
                                                    <FormFeedback type="invalid">{validation.errors.feeSchedule}</FormFeedback>
                                                )}
                                            </div>
                                        </Col>
                                    </Row>
