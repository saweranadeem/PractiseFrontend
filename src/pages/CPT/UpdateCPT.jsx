...
const UpdateCPT = () => {
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      defaultUnits: Yup.number()
        .required("Please enter default units")
        .positive()
        .integer(),
              ...
              <Card>
                ...
                <CardBody>
                  <Row>
                    ...
                    <Col lg={6}>
                      <div className="mb-3">
                        <label htmlFor="defaultUnits" className="form-label">
                          Default Units
                        </label>
                        <Input
                          id="defaultUnits"
                    ...
                    <Col lg={6}>
                      <div className="mb-3">
                        <label htmlFor="defaultModifier" className="form-label">
                          Default Modifier
                        </label>
                        <Input
                          id="defaultModifier"
                    ...
                    <Col lg={6}>
                      <div className="mb-3">
                        <label htmlFor="feeSchedule" className="form-label">
                          Fee Schedule
                        </label>
                        <Input
                          id="feeSchedule"
