...
// add Clinic
export const addNewClinic = clinic => api.create(url.ADD_NEW_CLINIC, clinic);
// add User
export const addNewUser = user => api.create(url.ADD_NEW_USER, user);
// add Patient
export const addNewPatient = patient => api.create(url.ADD_NEW_PATIENT, patient);
// add Setting
export const addNewSetting = setting => api.create(url.ADD_NEW_SETTING, setting);
// add Doctor
export const addNewDoctor = doctor => api.create(url.ADD_NEW_DOCTOR, doctor);
// add CPT
export const addNewCpt = cpt => api.create(url.ADD_NEW_CPT, cpt);
