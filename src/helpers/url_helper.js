...
export const DELETE_EVENT = "/appointments/";
...
// export const GET_PRODUCTS = "/apps/product";
// export const DELETE_PRODUCT = "/apps/product";
export const ADD_NEW_CLINIC = "/clinic";
// export const UPDATE_PRODUCT = "/apps/product";
// User
...
// Setting
export const ADD_NEW_SETTING = "/setting";
// Doctor
export const ADD_NEW_DOCTOR = "/doctors";
// CPT
export const ADD_NEW_CPT = "/cpt";
