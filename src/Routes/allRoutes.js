...
// Clinics
import ListClinics from "../pages/Clinics/List"
import CreateClinics from "../pages/Clinics/CreateClinics"
import UpdateClinics from "../pages/Clinics/UpdateClinics"

// Users
import ListUsers from "../pages/Users/ListUser"
import CreateUsers from "../pages/Users/AddUser"
import UpdateUser from "../pages/Users/UpdateUser"

// Patients
import ListPatients from "../pages/Patients/ListPatients"
import CreatePatients from "../pages/Patients/AddPatient"
import UpdatePatient from "../pages/Patients/UpdatePatient"
// Patients
import ListDoctors from "../pages/Doctors/Doctors"
import CreateDoctors from "../pages/Doctors/AddDoctors"
import UpdateDoctors from "../pages/Doctors/UpdateDoctors"
// CPT CODES
import ListCPTS from "../pages/CPT/ListCPT"
...
const authProtectedRoutes = [
  ...
  //Clinics
  { path: "/clinics-list", component: <ListClinics /> },
  { path: "/clinics-create", component: <CreateClinics /> },
  { path: "/clinics-edit/:id", component: <UpdateClinics /> },
  ...
  { path: "/patient-create", component: <CreatePatients /> },
  { path: "/patient-edit/:id", component: <UpdatePatient /> },
   //Doctors
   { path: "/doctors-list", component: <ListDoctors /> },
   { path: "/doctor-create", component: <CreateDoctors /> },
   { path: "/doctor-edit/:id", component: <UpdateDoctors /> },
     //CPT Codes
     { path: "/cpt-list", component: <ListCPTS /> },
     { path: "/cpt-create", component: <CreateCPTS /> },
     { path: "/cpt-edit/:id", component: <UpdateCPTS /> },
